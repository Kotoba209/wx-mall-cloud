...
本次项目更改主要是把1~4的数据放在了云开发的数据库中存取。 地址接口的实现， 需要省市区等这些数据， 所以就不考虑自己写了， 想要做这步的 这里有数据 [cityDataArr.json](https://6c65-leeson-a5fee7-1257914072.tcb.qcloud.la/666/cityDataArr.json?sign=30a3c877aeb945f6b6e0419237fb126b&t=1541577824)， 至于创建订单， 视频中的老师说的是个人开发者没法实现，  只能企业才可以， 具体的我也没去细看，  所以这一步也就先使用的api工厂的
